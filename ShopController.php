...
class ShopController extends Controller
{
    public function __invoke()
    {
        return view('shop.shop', [
            'articles_bundle' => WebsiteShopArticles::where('category','bundle')->orderBy('position')->with(['rank:id,rank_name', 'features'])->get(),
            'articles_alacarte' => WebsiteShopArticles::where('category','alacarte')->orderBy('position')->with(['rank:id,rank_name', 'features'])->get(),
            'articles_onlyinterplus' => WebsiteShopArticles::where('category','onlyinterplus')->orderBy('position')->with(['rank:id,rank_name', 'features'])->get(),
