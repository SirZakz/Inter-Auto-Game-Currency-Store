...
Route::middleware(['maintenance', 'check.ban', 'force.staff.2fa'])->group(function () {
    ...
    Route::middleware('auth')->group(function () {
        ...
        Route::prefix('ranking')->group(function () {
            Route::get('/', [MeController::class, 'index'])->name('ranking.index');

            Route::withoutMiddleware('auth')->group(function () {

                Route::get('/leaderboard', LeaderboardController::class)->name('leaderboard.index');
                Route::get('/gameboard', GameboardController::class)->name('gameboard.index');
            });
        });   
        ...
        Route::prefix('community')->group(function () {
            ...
            Route::withoutMiddleware('auth')->group(function () {
                ...
                Route::get('/stars', StarsController::class)->name('stars.index');
            });
        ...
        Route::prefix('payment')->group(function () {
            Route::get('/', PaymentController::class)->name('payment.index');
            Route::get('/success', [PaymentController::class, 'paymentSuccess'])->name('payment.success');
            Route::post('/proceed', [PaymentController::class, 'proceedPayment'])->name('payment.proceed');
        });

        //Stripe route
        // Route::prefix('store')->group(function () {
        //     Route::post('/payment', 'PaymentController@processPayment')->name('store.payment');
